...
focal_mapfilt_snps <- read.csv("data/readlist_PEindivs.allindiv.allchroms.vcf.summary.dedupheaders.filt.mapfilt.bed",sep="\t", header=FALSE)
...
write.table(focal_mapfilt_snps,file="data/readlist_PEindivs.allindiv.allchroms.vcf.summary.dedupheaders.filt.mapfilt.reformatted", row.names=F, col.names=F, sep = "\t", quote = FALSE)
